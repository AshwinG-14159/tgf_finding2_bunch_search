There was too much confusion in the original repo present in the sem_5_content folder (repo name TGF_finding). Going to use this new repo to separate out the bunch searches and work with them
